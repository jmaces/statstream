...
from .exact import (
    streaming_min, streaming_max, streaming_mean, streaming_mean_and_var,
    streaming_mean_and_std, streaming_mean_and_cov,
    streaming_mean_and_variance, streaming_mean_and_covariance, streaming_var,
    streaming_std, streaming_cov, streaming_variance, streaming_covariance,

    s_min, s_max, s_mean, s_mean_and_var, s_mean_and_std, s_mean_and_cov,
    s_mean_and_variance, s_mean_and_covariance, s_var, s_std, s_cov,
    s_variance, s_covariance,
)
