...
Thank you for considering contributing to ``statstream``!
...
Then get an up to date checkout of the ``statstream`` repository:

.. code-block:: bash

    $ git clone git@github.com:jmaces/statstream.git

or if you want to use git via ``https``:

.. code-block:: bash

    $ git clone https://github.com/jmaces/statstream.git

Change into the newly created directory and **activate your virtual environment**
if you have not done that already. Install an editable version of ``statstream``
...
``statstream`` was created as a byproduct of a research project and is
...
Thank you again for considering contributing to ``statstream``!
...
.. _`Code of Conduct`: https://github.com/jmaces/statstream/blob/master/.github/CODE_OF_CONDUCT.rst
.. _changelog: https://github.com/jmaces/statstream/blob/master/CHANGELOG.rst
.. _tox: https://tox.readthedocs.io/
.. _reStructuredText: https://www.sphinx-doc.org/en/master/usage/restructuredtext/basics.html
.. _semantic newlines: https://rhodesmill.org/brandon/2012/one-sentence-per-line/
.. _examples page: https://github.com/jmaces/statstream/blob/master/docs/examples.rst
.. _CI: https://travis-ci.com/jmaces/statstream
